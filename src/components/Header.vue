  ...
  <div class="header">
    ...
    <div class="header-menu">
      <b-navbar type="dark" variant="dark" toggleable="lg">
        <b-navbar-brand href="#">
          <router-link to='/' replace>
            <img width="79px" class="logo" alt="logo" src="../assets/logo.png">
          </router-link>
        </b-navbar-brand>
        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav>
            <b-nav-item-dropdown :text='item.title' v-for="item in menus" :key="item.title">
              <b-dropdown-item v-for="i in item.menu" :key="i.title">
                {{i.title}}
              </b-dropdown-item>
            </b-nav-item-dropdown>
          </b-navbar-nav>
...
.header {
  ...
  .go-top {
    ...
    right: 3rem;
    bottom: 3rem;
    background: url("https://aukeyoss.oss-us-west-1.aliyuncs.com/top.png") 50%/100%
      no-repeat;
    z-index: 10000;
    cursor: pointer;
    display: none;
